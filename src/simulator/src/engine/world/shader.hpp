...
class Shader {
  ...
  public:
    ...
    Shader(const char *vsFilePath, const char *fsFilePath,
        ...
        std::string vertexPath = PATH_SHADER + std::string(vsFilePath);
        std::string fragmentPath = PATH_SHADER + std::string(fsFilePath);
        ...
        if (gsFilePath) {
            std::string geometryPath = PATH_SHADER + std::string(gsFilePath);
