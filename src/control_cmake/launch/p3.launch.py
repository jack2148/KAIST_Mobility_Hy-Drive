...
def generate_launch_description():
    ...
    # =======================================================
    # Stanley Nodes (각자 다른 CSV 파일을 로드해야 함)
    # =======================================================
    ...
    stanley_cav_01 = Node(
        ...
        name='stanley_controller_01', 
        namespace='CAV_01',           
        output='screen',
        parameters=[{
            'original_way_path': 'tool/cav1p3.csv',
    ...
    stanley_cav_02 = Node(
        ...
        output='screen',
        parameters=[{
            'original_way_path': 'tool/cav2p3.csv',   # <--- 여기 확인!
    ...
    # 3. CAV 03 (오타 수정됨: controller_03)
    stanley_cav_03 = Node(
        package='control_cmake',
        executable='stanley_node',
        name='stanley_controller_03', # [중요] 아까 02로 되어있었음!
        namespace='CAV_03',         
        output='screen',
        parameters=[{
            'original_way_path': 'tool/cav3p3.csv',
    ...
    stanley_cav_04 = Node(
        ...
        output='screen',
        parameters=[{
            'original_way_path': 'tool/cav4p3.csv',
